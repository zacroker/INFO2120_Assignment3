...
Return information:
    return None - when the database fails to connect
    return -1 - when the user/password combination is Incorrect
...
def check_login(member_id, password):
    ...
    if conn == None:
        ...
        return None # By returning none the database error is handled by routes.py
    ...
    # If there is an error, send a message to the debugger
        ...
        return None # What does an error here really mean? Should be handled by routes.py tho...
